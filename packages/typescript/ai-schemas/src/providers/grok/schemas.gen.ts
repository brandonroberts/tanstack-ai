...
export const ChatResponseChunkSchema = {
  type: 'object',
  required: ['id', 'object', 'created', 'model', 'choices'],
  properties: {
    choices: {
      type: 'array',
      items: { $ref: '#/$defs/ChoiceChunk' },
      description:
        'A list of response choices from the model. The length corresponds to the `n` in request body (default to 1).',
    },
    citations: {
    ...
    output_files: {
      ...
      items: { $ref: '#/$defs/OutputFile' },
      description:
        'Files generated during the response (e.g., by the code execution tool).\nOnly populated for the final chunk when `code_execution_files_output` is included.',
    },
    system_fingerprint: {
      type: ['string', 'null'],
      description:
...
export const ChoiceChunkSchema = {
  type: 'object',
  required: ['index', 'delta'],
  properties: {
    delta: {
...
export const ContentFormatSchema = {
  type: 'string',
  description: 'Format of the downloaded file content.',
  enum: ['original', 'text'],
} as const
...
export const DeleteStoredCompletionResponseSchema = {
  type: 'object',
...
export const DocumentsSourceSchema = {
  type: 'object',
  description:
  ...
  $defs: { RagPipeline: { type: 'string', enum: ['chroma_db', 'es'] } },
} as const

export const DownloadFileContentParamsSchema = {
  type: 'object',
  description: 'Query parameters for downloading file content.',
  properties: {
    format: {
      oneOf: [
        { type: 'null' },
...
export const FileSchema = {
  ...
  required: ['bytes', 'created_at', 'filename', 'id', 'object'],
  properties: {
    bytes: {
      type: 'integer',
      format: 'int64',
    ...
    created_at: {
      type: 'integer',
      format: 'int64',
      description: 'The Unix timestamp (in seconds) for file creation time.',
    },
    expires_at: {
      type: ['integer', 'null'],
      format: 'int64',
...
export const GeneratedVideoSchema = {
  type: 'object',
  description: 'Generated video.',
  required: ['duration', 'respect_moderation'],
  properties: {
    duration: {
      type: 'integer',
      format: 'int32',
...
export const GetDeferredVideoRequestSchema = {
  type: 'object',
  description: 'Request to get deferred video result with a request ID.',
  required: ['request_id'],
  properties: {
    request_id: {
      type: 'string',
...
export const GetDeferredVideoResponseSchema = {
  type: 'object',
  ...
  properties: {
    response: {
      oneOf: [
        { type: 'null' },
        {
          $ref: '#/$defs/VideoResponse',
          description:
            'The generated video response. Only present if status is "done" or "failed".\nWhen failed, the `error` field in VideoResponse describes the failure.',
        },
      ],
    },
    status: {
  ...
  $defs: {
    ...
    VideoError: {
      type: 'object',
      description: 'Structured error returned when video generation fails.',
      required: ['code', 'message'],
      properties: {
        code: {
          $ref: '#/$defs/VideoErrorCode',
          description:
            'Machine-readable error code indicating the type of failure.\nSee `VideoErrorCode` for all possible values.',
        },
        message: {
          type: 'string',
        ...
        error: {
          oneOf: [
            { type: 'null' },
            {
              $ref: '#/$defs/VideoError',
              description:
                'Structured error describing why video generation failed.\nOnly present when the generation encountered a failure (4xx or 5xx).',
            },
          ],
        },
        model: {
...
export const GetMeResponseSchema = {
  ...
  required: ['user_id', 'team_id', 'zdr_status', 'team_blocked'],
  properties: {
    api_key: {
      oneOf: [
        { type: 'null' },
        {
          $ref: '#/$defs/MeApiKeyInfo',
    ...
    oauth: {
      oneOf: [
        { type: 'null' },
        {
          $ref: '#/$defs/MeOAuthInfo',
          description: 'Present when authenticated with an OAuth token.',
        },
      ],
    },
    team_blocked: {
      type: 'boolean',
      description: 'Whether the team is blocked from making API requests.',
    },
    team_id: {
      type: 'string',
      description: 'Team ID associated with the credentials.',
    },
    user_id: {
      type: 'string',
      description: 'User ID associated with the credentials.',
    },
    zdr_status: {
      type: 'string',
      description:
  ...
  $defs: {
    MeApiKeyInfo: {
      type: 'object',
      description: 'API key details nested in the `/v1/me` response.',
      required: ['redacted_api_key', 'api_key_id', 'blocked', 'disabled'],
      properties: {
        api_key_id: { type: 'string', description: 'The API key ID.' },
        blocked: {
          type: 'boolean',
          description: 'Whether the API key is blocked.',
        },
        disabled: {
          type: 'boolean',
    ...
    MeOAuthInfo: {
      type: 'object',
      description: 'OAuth token details nested in the `/v1/me` response.',
      required: ['client_id'],
      properties: {
        client_id: {
          type: 'string',
...
export const GroupBySchema = {
  ...
  properties: {
    ...
    keys: {
      ...
      items: { type: 'string' },
      description:
        'Metadata key(s) to group results by (e.g. "category", "department").\nAt least one key is required.',
    },
  },
  $defs: {
    GroupByAggregate: {
      oneOf: [
        {
          type: 'object',
          description:
            'Keep the k records with the smallest values (best scores).',
          required: ['min_k'],
          properties: {
            min_k: {
              type: 'object',
        ...
        {
          type: 'object',
          description: 'Keep the k records with the largest values.',
          required: ['max_k'],
          properties: {
            max_k: {
              type: 'object',
              ...
              properties: {
                ...
                keys: {
                  type: 'array',
                  items: { type: 'string' },
                  description: 'Key(s) to sort by within each group.',
                },
              },
            },
          },
      ...
      description: 'Aggregation function to apply within each group.',
    },
  },
} as const

export const GroupByAggregateSchema = {
  oneOf: [
    {
      type: 'object',
      description: 'Keep the k records with the smallest values (best scores).',
      required: ['min_k'],
      properties: {
        min_k: {
          type: 'object',
          ...
          properties: {
            k: {
              type: 'integer',
              format: 'int32',
              description: 'Number of records to keep per group. Must be >= 1.',
            },
            keys: {
              type: 'array',
              items: { type: 'string' },
...
export const HybridRerankerSchema = {
  oneOf: [
    {
      allOf: [
        {
...
export const HybridRetrievalSchema = {
  type: 'object',
  description:
      ...
      oneOf: [
        {
          allOf: [
            ...
            },
            {
              ...
              required: ['type'],
              properties: {
                type: { type: 'string', enum: ['reranker_model'] },
              },
            },
          ],
          description: 'Use a reranker model to perform the reranking.',
...
export const ImageGenerationModelSchema = {
  type: 'object',
...
export const InputItemEntrySchema = {
  allOf: [
    { $ref: '#/$defs/ModelInputPart', description: 'The input item content.' },
    {
      type: 'object',
      required: ['id'],
      properties: {
        id: {
          type: 'string',
          description: 'Stable identifier for this item within the response.',
        },
      },
    },
  ],
...
export const KeywordRetrievalSchema = {
  type: 'object',
...
export const ListEmbeddingModelsResponseSchema = {
  type: 'object',
  required: ['models'],
  properties: {
    models: {
      type: 'array',
      items: { $ref: '#/$defs/EmbeddingModel' },
...
export const ListFilesParamsSchema = {
  type: 'object',
  description: 'Parameters to control listing of files.',
  properties: {
    after: {
      type: ['string', 'null'],
      description:
...
export const ListFilesResponseSchema = {
  ...
  properties: {
    ...
    pagination_token: {
      type: ['string', 'null'],
      description: 'Pagination token to use with next request.',
    },
  },
  $defs: {
    File: {
...
export const ListImageGenerationModelsResponseSchema = {
  type: 'object',
  required: ['models'],
  properties: {
    models: {
      type: 'array',
      items: { $ref: '#/$defs/ImageGenerationModel' },
...
export const ListInputItemsResponseSchema = {
  type: 'object',
  description: 'A paginated list of input items for a stored response.',
  required: ['object', 'data', 'has_more'],
  properties: {
    data: {
      type: 'array',
      items: { $ref: '#/$defs/InputItemEntry' },
    ...
    object: { type: 'string', description: 'The object type, always `list`.' },
  },
  $defs: {
    Annotation: {
      type: 'object',
    ...
    InputItemEntry: {
      allOf: [
        {
          $ref: '#/$defs/ModelInputPart',
          description: 'The input item content.',
        },
        {
          type: 'object',
          required: ['id'],
...
export const ListLanguageModelsResponseSchema = {
  type: 'object',
  required: ['models'],
  properties: {
    models: {
      type: 'array',
      items: { $ref: '#/$defs/LanguageModel' },
...
export const ListVideoGenerationModelsResponseSchema = {
  type: 'object',
  required: ['models'],
  properties: {
    models: {
      type: 'array',
      items: { $ref: '#/$defs/VideoGenerationModel' },
      description: 'Array of available video generation models.',
    },
  },
  $defs: {
    VideoGenerationModel: {
      type: 'object',
      description: 'Details of a video generation model',
      required: [
        'id',
        'fingerprint',
        'created',
...
export const MeApiKeyInfoSchema = {
  type: 'object',
  description: 'API key details nested in the `/v1/me` response.',
  required: ['redacted_api_key', 'api_key_id', 'blocked', 'disabled'],
  properties: {
...
export const MeOAuthInfoSchema = {
  type: 'object',
  description: 'OAuth token details nested in the `/v1/me` response.',
  required: ['client_id'],
  properties: {
...
export const RagPipelineSchema = {
  type: 'string',
  enum: ['chroma_db', 'es'],
} as const

export const RankingMetricSchema = {
  type: 'string',
...
export const ReciprocalRankFusionSchema = {
  type: 'object',
  description: 'Configuration for reciprocal rank fusion (RRF) reranking.',
  properties: {
    embedding_weight: {
...
export const RerankerModelSchema = {
  type: 'object',
  description: 'Configuration for model-based reranking.',
  properties: {
    instructions: {
...
export const SearchRequestSchema = {
    ...
    group_by: {
      oneOf: [
        { type: 'null' },
        {
          $ref: '#/$defs/GroupBy',
          description:
            'Optional group_by to diversify search results by metadata key(s).\nWhen set, results are grouped by the specified key(s) and only the\ntop-k records per group are returned. Applied after ranking and filtering.\nDocuments missing a group_by key are placed in a shared null group.\nGrouping is applied per-collection, not across the combined result set.',
        },
      ],
    },
    instructions: {
  ...
  $defs: {
    ...
    RagPipeline: { type: 'string', enum: ['chroma_db', 'es'] },
    RankingMetric: {
      type: 'string',
      description: 'Deprecated: Metric now comes from collection creation.',
      enum: [
...
export const SortOrderSchema = {
  type: 'string',
  description: 'Sort order for paginated listings.',
  enum: ['asc', 'desc'],
} as const

export const StartDeferredChatResponseSchema = {
  type: 'object',
  required: ['request_id'],
  properties: {
    request_id: {
...
export const UploadFileMultipartRequestSchema = {
  type: 'object',
  description:
...
export const VideoErrorCodeSchema = {
  type: 'string',
  description:
    'Machine-readable error codes for video generation failures.\n\nThese are the codes that can appear in `VideoError.code` when polling a\ndeferred video generation result. Authentication errors, model-not-found\nerrors, and rate-limit errors are returned synchronously as HTTP errors\nand never appear in `VideoError`.\n\nSerializes to/from snake_case strings (e.g. `"invalid_argument"`,\n`"internal_error"`) for JSON compatibility.',
  enum: [
