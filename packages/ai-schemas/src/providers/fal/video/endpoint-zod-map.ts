...
import {
  ...
  zControlfoleyInput,
  zControlfoleyOutput,
  zCosmos3SuperImageToVideoInput,
  zCosmos3SuperImageToVideoOutput,
  ...
  zFfmpegApiImagesToVideoInput,
  zFfmpegApiImagesToVideoOutput,
  ...
  zGrokImagineVideoV15ImageToVideoOutput,
  ...
  zHeygenAvatar5DigitalTwinInput,
  zHeygenAvatar5DigitalTwinOutput,
  ...
  zLtx23QualityAudioToVideoInput,
  zLtx23QualityAudioToVideoLoraInput,
  zLtx23QualityAudioToVideoLoraOutput,
  zLtx23QualityAudioToVideoOutput,
  zLtx23QualityHdrInput,
  zLtx23QualityHdrLoraInput,
  zLtx23QualityHdrLoraOutput,
  zLtx23QualityHdrOutput,
  zLtx23QualityImageToVideoInput,
  zLtx23QualityImageToVideoLoraInput,
  zLtx23QualityImageToVideoLoraOutput,
  zLtx23QualityImageToVideoOutput,
  zLtx23QualityReferenceVideoToVideoInput,
  zLtx23QualityReferenceVideoToVideoLoraInput,
  zLtx23QualityReferenceVideoToVideoLoraOutput,
  zLtx23QualityReferenceVideoToVideoOutput,
  zLtx23QualityTextToVideoInput,
  zLtx23QualityTextToVideoLoraInput,
  zLtx23QualityTextToVideoLoraOutput,
  zLtx23QualityTextToVideoOutput,
  ...
  zSfx16VideoToVideoInput,
  zSfx16VideoToVideoOutput,
...
/**
 * Map of fal-video endpoint id -> Zod input/output schemas.
 * Entries without `output` stream binary media (audio/video) rather
 * than returning JSON.
 */
export const falVideoEndpointZodMap: {
  ...
  readonly 'fal-ai/birefnet/v2/video': {
    ...
    readonly output: typeof zBirefnetV2VideoOutput
  }
  ...
  readonly 'fal-ai/ffmpeg-api/compose': {
    readonly input: typeof zFfmpegApiComposeInput
    readonly output: typeof zFfmpegApiComposeOutput
  }
  readonly 'fal-ai/ffmpeg-api/images-to-video': {
    readonly input: typeof zFfmpegApiImagesToVideoInput
    readonly output: typeof zFfmpegApiImagesToVideoOutput
  }
  readonly 'fal-ai/ffmpeg-api/merge-audio-video': {
    readonly input: typeof zFfmpegApiMergeAudioVideoInput
    readonly output: typeof zFfmpegApiMergeAudioVideoOutput
  }
  readonly 'fal-ai/ffmpeg-api/merge-videos': {
    readonly input: typeof zFfmpegApiMergeVideosInput
    readonly output: typeof zFfmpegApiMergeVideosOutput
  }
  readonly 'fal-ai/film/video': {
    readonly input: typeof zFilmVideoInput
    readonly output: typeof zFilmVideoOutput
  }
  ...
  readonly 'fal-ai/heygen/avatar5/digital-twin': {
    readonly input: typeof zHeygenAvatar5DigitalTwinInput
    readonly output: typeof zHeygenAvatar5DigitalTwinOutput
  }
  ...
  readonly 'fal-ai/ltx-2.3-quality/audio-to-video': {
    readonly input: typeof zLtx23QualityAudioToVideoInput
    readonly output: typeof zLtx23QualityAudioToVideoOutput
  }
  readonly 'fal-ai/ltx-2.3-quality/audio-to-video/lora': {
    readonly input: typeof zLtx23QualityAudioToVideoLoraInput
    readonly output: typeof zLtx23QualityAudioToVideoLoraOutput
  }
  readonly 'fal-ai/ltx-2.3-quality/hdr': {
    readonly input: typeof zLtx23QualityHdrInput
    readonly output: typeof zLtx23QualityHdrOutput
  }
  readonly 'fal-ai/ltx-2.3-quality/hdr/lora': {
    readonly input: typeof zLtx23QualityHdrLoraInput
    readonly output: typeof zLtx23QualityHdrLoraOutput
  }
  readonly 'fal-ai/ltx-2.3-quality/image-to-video': {
    readonly input: typeof zLtx23QualityImageToVideoInput
    readonly output: typeof zLtx23QualityImageToVideoOutput
  }
  readonly 'fal-ai/ltx-2.3-quality/image-to-video/lora': {
    readonly input: typeof zLtx23QualityImageToVideoLoraInput
    readonly output: typeof zLtx23QualityImageToVideoLoraOutput
  }
  readonly 'fal-ai/ltx-2.3-quality/reference-video-to-video': {
    readonly input: typeof zLtx23QualityReferenceVideoToVideoInput
    readonly output: typeof zLtx23QualityReferenceVideoToVideoOutput
  }
  readonly 'fal-ai/ltx-2.3-quality/reference-video-to-video/lora': {
    readonly input: typeof zLtx23QualityReferenceVideoToVideoLoraInput
    readonly output: typeof zLtx23QualityReferenceVideoToVideoLoraOutput
  }
  readonly 'fal-ai/ltx-2.3-quality/text-to-video': {
    readonly input: typeof zLtx23QualityTextToVideoInput
    readonly output: typeof zLtx23QualityTextToVideoOutput
  }
  readonly 'fal-ai/ltx-2.3-quality/text-to-video/lora': {
    readonly input: typeof zLtx23QualityTextToVideoLoraInput
    readonly output: typeof zLtx23QualityTextToVideoLoraOutput
  }
  ...
  readonly 'fal-ai/wan-pro/image-to-video': {
    readonly input: typeof zWanProImageToVideoInput
    readonly output: typeof zWanProImageToVideoOutput
  }
  readonly 'fal-ai/wan-pro/text-to-video': {
    readonly input: typeof zWanProTextToVideoInput
    readonly output: typeof zWanProTextToVideoOutput
  }
  ...
  readonly 'fal-ai/wan/v2.7/image-to-video': {
    readonly input: typeof zWanV27ImageToVideoInput
    readonly output: typeof zWanV27ImageToVideoOutput
  }
  ...
  readonly 'mirelo-ai/sfx1.6/video-to-video': {
    readonly input: typeof zSfx16VideoToVideoInput
    readonly output: typeof zSfx16VideoToVideoOutput
  }
  ...
  readonly 'nvidia/cosmos-3-super/image-to-video': {
    readonly input: typeof zCosmos3SuperImageToVideoInput
    readonly output: typeof zCosmos3SuperImageToVideoOutput
  }
  ...
  readonly 'veed/subtitles': {
    readonly input: typeof zSubtitlesInput
    readonly output: typeof zSubtitlesOutput
  }
  ...
  readonly 'xai/grok-imagine-video/v1.5/image-to-video': {
    readonly input: typeof zGrokImagineVideoV15ImageToVideoInput
    readonly output: typeof zGrokImagineVideoV15ImageToVideoOutput
  }
} = {
  ...
  'fal-ai/ffmpeg-api/images-to-video': {
    input: zFfmpegApiImagesToVideoInput,
    output: zFfmpegApiImagesToVideoOutput,
  },
  ...
  'fal-ai/film/video': { input: zFilmVideoInput, output: zFilmVideoOutput },
  ...
  'fal-ai/heygen/avatar5/digital-twin': {
    input: zHeygenAvatar5DigitalTwinInput,
    output: zHeygenAvatar5DigitalTwinOutput,
  },
  ...
  'fal-ai/ltx-2.3-quality/audio-to-video': {
    input: zLtx23QualityAudioToVideoInput,
    output: zLtx23QualityAudioToVideoOutput,
  },
  'fal-ai/ltx-2.3-quality/audio-to-video/lora': {
    input: zLtx23QualityAudioToVideoLoraInput,
    output: zLtx23QualityAudioToVideoLoraOutput,
  },
  'fal-ai/ltx-2.3-quality/hdr': {
    input: zLtx23QualityHdrInput,
    output: zLtx23QualityHdrOutput,
  },
  'fal-ai/ltx-2.3-quality/hdr/lora': {
    input: zLtx23QualityHdrLoraInput,
    output: zLtx23QualityHdrLoraOutput,
  },
  'fal-ai/ltx-2.3-quality/image-to-video': {
    input: zLtx23QualityImageToVideoInput,
    output: zLtx23QualityImageToVideoOutput,
  },
  'fal-ai/ltx-2.3-quality/image-to-video/lora': {
    input: zLtx23QualityImageToVideoLoraInput,
    output: zLtx23QualityImageToVideoLoraOutput,
  },
  'fal-ai/ltx-2.3-quality/reference-video-to-video': {
    input: zLtx23QualityReferenceVideoToVideoInput,
    output: zLtx23QualityReferenceVideoToVideoOutput,
  },
  'fal-ai/ltx-2.3-quality/reference-video-to-video/lora': {
    input: zLtx23QualityReferenceVideoToVideoLoraInput,
    output: zLtx23QualityReferenceVideoToVideoLoraOutput,
  },
  'fal-ai/ltx-2.3-quality/text-to-video': {
    input: zLtx23QualityTextToVideoInput,
    output: zLtx23QualityTextToVideoOutput,
  },
  'fal-ai/ltx-2.3-quality/text-to-video/lora': {
    input: zLtx23QualityTextToVideoLoraInput,
    output: zLtx23QualityTextToVideoLoraOutput,
  },
  ...
  'mirelo-ai/sfx1.6/video-to-video': {
    input: zSfx16VideoToVideoInput,
    output: zSfx16VideoToVideoOutput,
  },
  ...
  'nvidia/cosmos-3-super/image-to-video': {
    input: zCosmos3SuperImageToVideoInput,
    output: zCosmos3SuperImageToVideoOutput,
  },
  ...
  'veed/subtitles': { input: zSubtitlesInput, output: zSubtitlesOutput },
  ...
  'xai/grok-imagine-video/v1.5/image-to-video': {
    input: zGrokImagineVideoV15ImageToVideoInput,
    output: zGrokImagineVideoV15ImageToVideoOutput,
  },
}

/** Union of valid fal-video endpoint ids. */
export type FalVideoEndpointId = keyof typeof falVideoEndpointZodMap
