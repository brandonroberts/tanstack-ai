...
Defined in: [packages/ai/src/activities/chat/middleware/types.ts:154](https://github.com/TanStack/ai/blob/main/packages/ai/src/activities/chat/middleware/types.ts#L154)
